...
python run.py model=mymodel_v5 data.dataset=Amazon_Office_Products_14 experiment.seed=42 experiment.device=$DEVICE training.batch=128 model.lambda_pair_align=1 model.orthogonal_residual_weight=0.0
