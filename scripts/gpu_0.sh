...
# python run.py model=rgcl data.dataset=Amazon_Office_Products_14 experiment.seed=42 experiment.device=0 
# python run.py model=rgcl data.dataset=Amazon_Office_Products_14 experiment.seed=64 experiment.device=0 
# python run.py model=rgcl data.dataset=Amazon_Office_Products_14 experiment.seed=57 experiment.device=0 
# python run.py model=rgcl data.dataset=Amazon_Office_Products_14 experiment.seed=2025 experiment.device=0 
# python run.py model=rgcl data.dataset=Amazon_Office_Products_14 experiment.seed=2026 experiment.device=0 