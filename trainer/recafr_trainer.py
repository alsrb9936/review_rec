...
class RecAFRTrainer(BaseTrainer):
    """Rating-prediction trainer for RecAFR.

    This follows the same BaseTrainer contract as LightGCNTrainer:
    - train_step returns a scalar loss
    - evaluate returns RMSE/MSE/MAE
    ...
    def train_step(self, batch) -> torch.Tensor:
        ...
        loss, _ = self.model.calculate_loss(
